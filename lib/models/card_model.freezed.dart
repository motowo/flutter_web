...
abstract class $CardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String type, String status, String company});
}
...
class _$_CardModel extends _CardModel {
  const _$_CardModel(
      {required this.type, required this.status, required this.company})
      : super._();
  ...
  @override
  String toString() {
    return 'CardModel(type: $type, status: $status, company: $company)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, type, status, company);
...
abstract class _CardModel extends CardModel {
  const factory _CardModel(
      ...
      required final String company}) = _$_CardModel;
